...
export default function MenuDialog() {
	...
	const goToReading = () => {
		history.push(learningLink.ImportContent);
		handleClose();
	};
	const goHome = () => {
			...
			>
				...
				<List>
					...
					<ListItem button onClick={goHome}>
						<ListItemText primary="Vocabulary" secondary="Excelent AI generator" />
					</ListItem>

					<ListItem button>
						<ListItemText primary="Grammar" secondary="Best practice" />
					</ListItem>
					<Divider />
